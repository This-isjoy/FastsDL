...
const dark_fut = document.getElementById("dark_fut");
...
darkMode.addEventListener("click", () => {
  ...
  features.style.background = "#636e66";
  dark_fut.style.background = "#636e66";
...
lightMode.addEventListener("click", () => {
  ...
  features.style.background = "#fff";
  dark_fut.style.background = "#fff";
